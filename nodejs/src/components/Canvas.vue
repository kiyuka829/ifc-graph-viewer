...
const nodes = ref<Node[]>([
  {
    ...
    type: "typeA",
    attributes: [
      { name: "attr1", content: "node2", edgePosition: {x: 186, y: 68}, inverse: false, visible: true },
      { name: "attr2", content: "Some text", edgePosition: {x: 186, y: 97}, inverse: true, visible: false }
    ],
  ...
  },
  {
    ...
    type: "typeB",
    attributes: [
      { name: "attr3", content: "node1", edgePosition: {x: 186, y: 68}, inverse: false, visible: true }
    ],
